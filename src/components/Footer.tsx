...
const SOCIALS = [
  {
    label: "Instagram",
    href: "https://www.instagram.com/co_aut",
  ...
  {
    label: "Facebook",
    href: "https://www.facebook.com/CoAutJuliette",
  ...
  {
    label: "LinkedIn",
    href: "https://www.linkedin.com/in/juliette-lejeune-/",
  ...
  return (
    <footer className="bg-aubergine text-white">
      <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-6 px-4 py-8 md:flex-row md:px-6">
        <Link href="/">
          <Image src="/images/logo-co-aut.png" alt="Logo Co-Aut" width={130} height={49} />
        </Link>

        <div className="text-center text-sm text-white/80">
          <p>Copyright © 2026 | Co-Aut</p>
          <p className="mt-1">
            <Link href="/mentions-legales" className="hover:text-peche">
              Mentions légales
            </Link>
            <span className="mx-2">|</span>
            <Link href="/politique-de-confidentialite" className="hover:text-peche">
        ...
        <ul className="flex items-center gap-4">
          {SOCIALS.map((s) => (
            <li key={s.label}>
              ...
              >
                <svg viewBox={s.viewBox} className="h-5 w-5 fill-white">
                  <path d={s.path} />
                </svg>
              </a>
            </li>
